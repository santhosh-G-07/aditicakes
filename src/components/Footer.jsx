                ...
                <div className="footer-content">
                    <div className="footer-section">
                        <h3 className="footer-logo">
                            <span>🎂</span> Aditi Cakes
                        </h3>
                        <p className="footer-description">
                            Freshly baked with love since October 2024. 100+ happy customers and counting!
                        </p>
                    ...
                    <div className="footer-section">
                        ...
                        <div className="footer-info">
                            ...
                            <p><strong>Pickup:</strong> Available</p>
                            <p><strong>Order Notice:</strong> 24 hours</p>
                        </div>
                    </div>
                </div>

                <div className="footer-bottom">
                    <p>&copy; {currentYear} Aditi Cakes. All rights reserved.</p>
                    <p className="developed-by">
                        Developed by <a href="https://www.thespydx.com" target="_blank" rel="noopener noreferrer">SpydX</a>
                    </p>
                </div>            </div>
        </footer>
    );
